...
// - has generated methods: toString, equals, hashCode, copy
...
val c2EqualsC3 = c2 equals c3 // c2.equals(c3)
// Equality check in Scala tolerates left hand null:
val c3IsNull = null == c3
...
def toCSS(color: Color): String = color match {
  ...
  case Color(red, g, b) => s"color: rgb($red, $g, $b)"
}
